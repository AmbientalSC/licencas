                                ...
                                >
                                    {columns.filter((col: typeof columns[0]) => col.visible).map((col: typeof columns[0], colIdx: number) => {
                                        switch (col.key) {
                                            ...
                                            case 'actions':
                                                return <td key={col.key} className="px-6 py-4 whitespace-nowrap text-sm font-medium"><div className="flex items-center gap-2"><button onClick={() => handleRowClick(license)} className="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 transition-colors"><PencilIcon /></button><button onClick={() => onDeleteLicense(license.id)} className="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 transition-colors"><TrashIcon /></button></div></td>;
                                            default:
                                                return null;
                                        }
                                    })}
